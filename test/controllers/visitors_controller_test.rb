...
class VisitorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create visitor" do
    assert_difference("Visitor.count") do
      post visitors_url, params: { visitor: { address: @visitor.address, email: @visitor.email, gender: @visitor.gender, name: @visitor.name, phonenumber: @visitor.phonenumber } }
    end
  ...
  test "should update visitor" do
    patch visitor_url(@visitor), params: { visitor: { address: @visitor.address, email: @visitor.email, gender: @visitor.gender, name: @visitor.name, phonenumber: @visitor.phonenumber } }
